...
lazy_static! {
  pub static ref CPU_OPS_CODES: Vec<OpCode> = vec![
    ...
    OpCode::new(0xd0, "BNE", 1, 6/*+1 if branch succeeds +2 if to a new page*/, AddressingMode::NoneAddressing),
    OpCode::new(0x70, "BVS", 1, 6/*+1 if branch succeeds +2 if to a new page*/, AddressingMode::NoneAddressing),
    OpCode::new(0x50, "BVC", 1, 6/*+1 if branch succeeds +2 if to a new page*/, AddressingMode::NoneAddressing),
    OpCode::new(0x30, "BMI", 1, 6/*+1 if branch succeeds +2 if to a new page*/, AddressingMode::NoneAddressing),
    OpCode::new(0xf0, "BEQ", 1, 6/*+1 if branch succeeds +2 if to a new page*/, AddressingMode::NoneAddressing),
    OpCode::new(0xb0, "BCS", 1, 6/*+1 if branch succeeds +2 if to a new page*/, AddressingMode::NoneAddressing),
    OpCode::new(0x90, "BCC", 1, 6/*+1 if branch succeeds +2 if to a new page*/, AddressingMode::NoneAddressing),
    OpCode::new(0x10, "BPL", 1, 6/*+1 if branch succeeds +2 if to a new page*/, AddressingMode::NoneAddressing),
